...
class PostInstallScript
{
    public static function postInstall(): void
    {
        ...
        if (!isset($config['doctrine']['orm']['entity_managers'][$selectedConnection])) {
            ...
            if (!isset($config['doctrine']['orm']['entity_managers'][$selectedConnection]['mappings']['ByteSpin\\ConsoleCommandSchedulerBundle'])) {
     ...
     */
    private static function askForDBALConnection(array $connections): string
    {
    ...
    private static function updateBundlesFile(string $bundlesFilePath): void
    {
